...
/**
 * @ClassName: SolarTermsUtil
 * @Description:TODO
 * @author: yigege
 * @date: 2021年03月30日 11:51
 */
public class SolarTermsUtil {
     ...
     * 国历节日 *表示放假日
     */
    private final static String[] sFtv = { "0101 元旦", "0214 情人节", "0308 妇女节", "0312 植树节", "0401 愚人节", "0501 劳动节", "0504 青年节", "0601 儿童节", "0618 618节" ,"0701 建党节", "0801 建军节", "0910 教师节", "1001 国庆节", "1111 双十一节" , "1225 圣诞节" };
    /**
     * 农历节日 *表示放假日
     */
    ...
    private void getCyclicalData() {
        ...
        int term2 = SolarTermsUtil.getSolarTermDay(solarYear, 2); // 立春日期
        // 依节气调整二月分的年柱, 以立春为界
        ...
        int firstNode = SolarTermsUtil.getSolarTermDay(solarYear, solarMonth * 2); // 传回当月「节」为几日开始
        // 依节气月柱, 以「节」为界
